        ...
        >
          ...
          <div className="mt-10 flex flex-wrap gap-5 justify-center">
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open("https://www.linkedin.com/in/induru-revanth-kumar-reddy-8a6684193", "_blank")}
            >
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open("https://github.com/rev-sketch", "_blank")}
            >
        ...
        >
          ...
          >
            <motion.li className="flex items-start" variants={fadeIn("up", "spring", 0.1, 0.75)}>
              ...
              <span>
                I&apos;m a Software Engineer with over 5 years of experience in software development and cloud technologies.
              </span>
            </motion.li>
            <motion.li className="flex items-start" variants={fadeIn("up", "spring", 0.2, 0.75)}>
              <span className="mr-4 text-2xl flex-shrink-0">🎓</span>
              <span>
                Pursuing my Master’s in Computer Science at the University of Texas at Arlington, building on a solid undergraduate foundation from NIT Calicut., I&apos;m all about building reliable, scalable software that makes a difference.
              </span>
            </motion.li>
