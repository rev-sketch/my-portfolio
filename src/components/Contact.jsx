  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Revanth Induru",
          from_email: form.email,
          to_email: "revanthinduru@gmail.com",
        ...
        >
          ...
          <label className="flex flex-col">
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder="Hey Revanth, love the website! I'd like to chat about some opportunities you might like! 🎉"
              className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium transition-all duration-300 focus:ring-2 focus:ring-purple-500"
            />
          </label>
          ...
          <div className="flex justify-center">
            <ReCAPTCHA
              sitekey={"6Ldqj6srAAAAAEYBq3XbPk--WK2nxTM0RagGo1h7"}
